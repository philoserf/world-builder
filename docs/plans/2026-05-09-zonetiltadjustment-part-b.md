...
```bash
git add worlds/temperature.go worlds/temperature_test.go docs/specs/2026-05-09-zonetiltadjustment-part-b-design.md docs/plans/2026-05-09-zonetiltadjustment-part-b.md
