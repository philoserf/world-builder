...
```bash
git add worlds/system_detail.go worlds/system_detail_pipeline.go worlds/system_detail_step5f.go worlds/biology.go worlds/biology_test.go worlds/system_detail_test.go docs/specs/2026-05-09-biology-oxygen-floor-design.md docs/plans/2026-05-09-biology-oxygen-floor.md
