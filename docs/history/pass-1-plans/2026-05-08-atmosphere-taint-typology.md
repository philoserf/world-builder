...
- **Spec:** `docs/history/pass-1-specs/2026-05-08-atmosphere-taint-typology-design.md` (commit `4f43b6d`)
...
> Final-gate review of the atmosphere-taint-typology branch. Compare implementation against `docs/history/pass-1-specs/2026-05-08-atmosphere-taint-typology-design.md` and WBH source pp.81-90 + biology pages 127, 129, 131.
>
