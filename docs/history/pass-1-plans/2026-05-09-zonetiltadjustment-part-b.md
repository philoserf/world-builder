...
```bash
git add worlds/temperature.go worlds/temperature_test.go docs/history/pass-1-specs/2026-05-09-zonetiltadjustment-part-b-design.md docs/history/pass-1-plans/2026-05-09-zonetiltadjustment-part-b.md
