...
**Spec:** `docs/history/pass-1-specs/2026-05-03-system-worlds-2c-sizing-design.md`
...
This plan implements sub-project 2C end-to-end against `docs/history/pass-1-specs/2026-05-03-system-worlds-2c-sizing-design.md`. **15 numbered tasks + Pre-flight + final hygiene** = the full 2C delivery.
