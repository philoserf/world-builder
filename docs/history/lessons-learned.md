...
Cycle 0 stubbed every public signature with `panic("unimplemented: see docs/api-surface.md § ...")`. Cycles 2-11 progressively replaced stubs with real implementations.
