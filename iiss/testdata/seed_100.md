...
### Cold snaps
- A IV: WorstLow 197 K (mean 251 K)
...
| --------- | ----- | ---- | -------- | -------- | ---------- | ----- | --- | --- | ---------- | --- | ---- | --------- |
| A | M0 V | 0.440 | 0.672 | 3700 | 0.0763 |  |  |  |  | 0.02 | 0.69 | -0.31–1.69 |
...
- Taint: G (severity 2, persistence 9)
...
- Escape velocity (m/s): 6135
- Size profile: `6-9600-0.53-0.40-0.23`
...
- Diameter (km): 9600, Density: 1.39, Gravity: 1.05, Mass (Earth): 0.594
- Escape velocity (m/s): 9936
- Size profile: `6-9600-1.39-1.05-0.59`

### ATMOSPHERE
- Code: 8, Pressure (bar): 1.665, O₂ (bar): 0.316, Scale Height: 7.07
- Profile: 8-1.665-0.316

### HYDROGRAPHICS
- Code: 9, Coverage (%): 95, Profile: H9:H2O-100
- Surface distribution: Mixed (Ocean)

### ROTATION
- Sidereal (h): 2400.00, Solar (h): 140518.18, Solar days/year: 0.02
- Axial Tilt: 10.00°
- Tidal lock: no, Tides (m): 2.42

### TEMPERATURE
- High (K): 284.6, Mean (K): 250.7, Low (K): 213.5
- Luminosity: 0.076, Albedo: 0.49, Greenhouse: 0.77

### SEISMIC
- TSS: 16, Residual: 16, Tidal Stress: 0, Tidal Heating: 0, Plates: 7

### LIFE
- Biomass: 8, Biocomplexity: 5, Sophonts: no, Biodiversity: 10, Compatibility: 3
...
### HABITABILITY
- Rating: 6
- Notes: Thin, taint (standard), or dense Atmospheres; Little useable land surface area; Too cold most of the time
...
- Escape velocity (m/s): 6809
- Size profile: `5-8000-0.94-0.59-0.23`

### ATMOSPHERE
- Code: 7, Pressure (bar): 1.253, O₂ (bar): 0.251, Scale Height: 11.27
- Profile: 7-1.253-0.251:R.6.4
- Taint: R (severity 6, persistence 4)

### HYDROGRAPHICS
- Code: 9, Coverage (%): 91, Profile: H9:H2O-100
- Surface distribution: Slightly Scattered (Ocean)
...
- Escape velocity (m/s): 5180
- Size profile: `4-6400-0.85-0.43-0.11`

### ATMOSPHERE
- Code: 2, Pressure (bar): 0.313, O₂ (bar): 0.154, Scale Height: 15.16
- Profile: 2-0.313-0.154:G.3.7
- Taint: G (severity 3, persistence 7)
